...
all:
	g++-8 -std=c++17 -Wall -pedantic -O2 -I. ./UserStructure.hpp ./BlockStructure.cpp ./BlockStructure.hpp ./ParsingBlocks.hpp ./clock.hpp ./main.cpp -lpthread -lstdc++fs -o parsing.out 
	./parsing.out ./steem_files
...
compile:
	g++ -std=c++17 -Wall -pedantic -O2 -I. ./UserStructure.hpp ./BlockStructure.cpp ./BlockStructure.hpp ./ParsingBlocks.hpp ./clock.hpp ./main.cpp -lpthread -lstdc++fs -o parsing.out 
